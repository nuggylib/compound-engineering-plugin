...
| 1 | Queryable Reference Libraries | 5 | done | done | | `docs/brainstorms/2026-04-19-queryable-reference-libraries-requirements.md`, `docs/plans/2026-04-19-003-refactor-queryable-reference-libraries-plan.md`. 3 encyclopedia skills. 75KB SKILL.md -> ~12.4KB thin routers. ~62KB always-loaded reduction, ~2.9M byte-calls savings. Plan refined 2026-04-20: measured budgets, parallel units, section mappings, dspy-ruby overlap fix. |
