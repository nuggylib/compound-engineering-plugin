...
| # | Idea | Complexity | Status | Dependencies | Notes |
|---|------|-----------|--------|-------------|-------|
| 1 | Queryable Reference Libraries | Medium | planned | #20 carrying cost (for priority), Phase 2 structural work | Plan refined 2026-04-20. 75KB -> ~12.4KB thin routers. Units 1-3 parallel. Ready for execution. |
| 11 | Compact Returns Generalization | Medium | done | #2 lean dispatch (pattern to generalize) | Executed. Write-once dispatch + compact returns. ~63-75KB savings per session. |
| 28 | Cartographic Zoom / Cartouches | Low-Medium | done | #2, #8 (need clean agent/skill boundaries first) | Executed: ~65% reduction in inline description bytes (~23KB -> ~8KB). 7 units across 6 orchestrators + AGENTS.md codification. |
...
| 7 | On-Demand Loading | 3 | done | done | done | `docs/brainstorms/2026-04-16-on-demand-loading-requirements.md`, `docs/plans/2026-04-16-001-refactor-on-demand-loading-plan.md`. 5 @-inlines converted to stage-specific backtick-path reads. ~29KB deferred from trigger-time load |
| 3 | Diff-Proportional Scaling | 3 | done | done | done | `docs/brainstorms/2026-04-16-diff-proportional-scaling-requirements.md`, `docs/plans/2026-04-16-002-refactor-diff-proportional-scaling-plan.md`. 5 units applied to SKILL.md: cap: arg token, EXECUTABLE_LINES counting, tier table + priority ordering, capped team announcement, mode compatibility |
...
| 1 | Queryable Reference Libraries | 5 | done | done | done | `docs/brainstorms/2026-04-19-queryable-reference-libraries-requirements.md`, `docs/plans/2026-04-19-003-refactor-queryable-reference-libraries-plan.md`. 3 encyclopedia skills converted to thin routers. 75,368B -> 14,902B (80.2% reduction). agent-native-architecture: 18,322B -> 4,987B (5 refs extracted). orchestrating-swarms: 35,574B -> 4,950B (9 refs extracted). dspy-ruby: 21,472B -> 4,965B (5 consolidated refs). All tests pass, release:validate passes. |
| 11 | Compact Returns Generalization | 5 | done | done | done | `docs/brainstorms/2026-04-19-compact-returns-generalization-requirements.md`, `docs/plans/2026-04-19-002-refactor-compact-returns-generalization-plan.md`. Scoped to document-review. Write-once dispatch + compact returns. ~63-75KB savings per 5-agent session. |
| 28 | Cartographic Zoom | 5 | done | done | done | `docs/brainstorms/2026-04-19-cartographic-zoom-requirements.md`, `docs/plans/2026-04-19-001-refactor-cartographic-zoom-plan.md`. 6 orchestrators. Cartouche tables reduce ~23KB -> ~8KB (65%). 7 units across 6 orchestrators + AGENTS.md codification. |
| 15 | Module Unbundling | 5 | done | skipped | skipped | `docs/brainstorms/2026-04-19-module-unbundling-requirements.md`. Deferred 2026-04-20: complexity not justified. Prior phases reduced carrying cost but always-loaded remains 86%. Budget is not blocking current work. Revisit if budget nears 100% or platform adds native module support. |
