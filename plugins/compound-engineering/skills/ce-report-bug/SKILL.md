...
Ask the user the following questions (via the platform question tool (AskUserQuestion / request_user_input / ask_user) — or present numbered options and wait for a reply):
