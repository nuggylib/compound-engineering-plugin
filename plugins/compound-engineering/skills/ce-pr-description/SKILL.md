...
Callers that need to ask the user are responsible for using their platform's question tool (AskUserQuestion / request_user_input / ask_user) before or after invoking this skill.
