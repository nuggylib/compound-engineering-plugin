...
description: "Build web interfaces with genuine design quality. Use for any frontend work including landing pages, dashboards, components, and interactive experiences."
---
...
When context is ambiguous, use the platform question tool (AskUserQuestion / request_user_input / ask_user). If no question tool is available, assume "partial" mode and proceed conservatively.
