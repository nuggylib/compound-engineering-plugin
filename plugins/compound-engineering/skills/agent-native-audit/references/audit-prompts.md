...
Each section contains the complete sub-agent prompt for one principle. The orchestrator reads this file and dispatches the prompt matching the target principle(s).
